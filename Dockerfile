...
RUN curl --silent -L https://github.com/Project-OSRM/osrm-backend/archive/v5.8.0-latest.1.tar.gz -o v5.8.0-latest.1.tar.gz \
 && tar xzf v5.8.0-latest.1.tar.gz \
 && mv osrm-backend-5.8.0-latest.1 /osrm-src \
 && cmake /osrm-src \
 && make \
